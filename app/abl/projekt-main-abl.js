...
const Errors = require("../api/errors/projekt-main-error.js");
...
const logger = LoggerFactory.get("ProjektMainAbl");

class ProjektMainAbl {
  constructor() {
...
module.exports = new ProjektMainAbl();
